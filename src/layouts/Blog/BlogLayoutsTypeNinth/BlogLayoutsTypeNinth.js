...
class BlogLayoutsTypeNinth extends Component {
    ...
    render() {
        const {author ,slug} = this.state.blog;
                            ...
                            <Row className={classes.contentRow}>
                                ...
                                <Col lg={8}>
                                    <Fade down triggerOnce={true} delay={200}>
                                        <div>
                                            <b>Analytics is a fantastic tool because it eliminates the guesswork as to how visitors behave on a website. Conversion rates are one of the top priorities for many marketing websites, and Analytics can certainly help give you insight as to why the conversion rate is what it is.</b>
